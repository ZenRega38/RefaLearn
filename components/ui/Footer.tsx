            ...
            <ul className="flex flex-col gap-3">
              <li className="flex items-start gap-2">
                ...
                <span className="text-sm text-[var(--color-ink-soft)] font-[var(--font-inter)]">
                  WhatsApp: <a href="https://wa.me/628135627087" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'none', fontWeight: 'bold' }}>+62 813 5627 087</a>
                </span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <a href="mailto:info.refalearn@gmail.com" className="text-sm text-[var(--color-ink-soft)] hover:text-[var(--color-brand-blue)] transition-colors font-[var(--font-inter)]">info.refalearn@gmail.com</a>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span className="text-sm text-[var(--color-ink-soft)] font-[var(--font-inter)]">Tarakan, Kalimantan Utara, Indonesia</span>
              </li>
            </ul>
          </div>
