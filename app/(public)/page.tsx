          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="lg:w-1/2 w-full max-w-lg">
              <Card variant="sketch" className="p-0 overflow-hidden bg-[var(--color-paper-bg)]">
                <div className="bg-[var(--color-brand-blue)] p-6 text-center">
                  <h3 className="text-white font-[var(--font-kalam)] text-2xl mb-1">Paket Privat 1-on-1</h3>
                  <p className="text-[var(--color-line)] text-sm font-[var(--font-inter)]">Harga per sesi 90 Menit</p>
                </div>
                <div className="p-4 sm:p-6 bg-white">
                  <div className="pricing-row">
                    <span className="font-semibold text-[var(--color-ink)] font-[var(--font-inter)] flex items-center gap-2">
                      Senin - Jumat
                    </span>
                    <span className="font-bold text-lg font-[var(--font-inter)] text-[var(--color-brand-blue)]">Rp 100.000</span>
                  </div>
                  <div className="pricing-row">
                    <span className="font-semibold text-[var(--color-ink)] font-[var(--font-inter)] flex items-center gap-2">
                      Sabtu
                    </span>
                    <span className="font-bold text-lg font-[var(--font-inter)] text-[var(--color-brand-blue)]">Rp 150.000</span>
                  </div>
                  <div className="pricing-row">
                    <span className="font-semibold text-[var(--color-ink)] font-[var(--font-inter)] flex items-center gap-2">
                      Minggu
                    </span>
                    <span className="font-bold text-lg font-[var(--font-inter)] text-[var(--color-brand-blue)]">
